...
#	define TRACE_DIE(x...)		fprintf(stderr, x)
...
#	define TRACE_LINES(x...)	fprintf(stderr, x)
...
#	define TRACE_LINES2(x...)	fprintf(stderr, x)
...
#	define TRACE_EXPR(x...)	fprintf(stderr, x)
...
#	define TRACE_PUBTYPES(x...)	fprintf(stderr, x)
...
#	define TRACE_CFI(x...)		fprintf(stderr, x)
...
#	define TRACE_LOCALS(x...)	fprintf(stderr, x)
...
#	define TRACE_IMAGES(x...)	fprintf(stderr, x)
...
#	define TRACE_CODE(x...)		fprintf(stderr, x)
...
#	define TRACE_JOBS(x...)		fprintf(stderr, x)
...
#	define TRACE_EVENTS(x...)	fprintf(stderr, x)
...
#	define TRACE_CONTROL(x...)	fprintf(stderr, x)
...
#	define TRACE_GUI(x...)		fprintf(stderr, x)
